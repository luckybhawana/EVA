...
?>
<section class = "event-Stripe" style = "background-color: #4e98cf; opacity: .9;">
<a style = "text-align: left; font-size: 30px;" href = "home.php">⇱</a><h1 class = "center-IT">Event Directory</h1>
</section>
<div id = 'content' style = "background-color: #333;opacity: .9;">
<?php
$query =  "SELECT * FROM EVENT ORDER BY EVENT_DATE ASC"; 
mysql_query($query);
if ($r = mysql_query($query))
{
	...
	while ($row = mysql_fetch_array($r)){
		...
		echo "<h3 class = 'centerIT'>Event Name: " . $row['EVENT_NAME'] . "<br />Event Date: " . $row['EVENT_DATE'] . "<br />Event Time: " . $row['EVENT_TIME'] . "<br />Event Location: " . $row['EVENT_LOCATION'] . "</h3>";
		echo "</td>";
		echo "<td>";
		...
		if ($rTwo = mysql_query($queryTwo))
		{
			...
			echo "<h3 class = 'centerIT'>Store: " . $rowTwo['STORE_NAME'] . "<br/>";
